...
import NonSpatialCommission from './NonSpatialCommission';
import CommissionSpatialCheck from './SpatialCommission';
...
const CommissionMain = () => {
  ...
  return (
    <>
      ...
      {nonSpatial === 1 && <NonSpatialCommission />}
      {spatialCheck === 1 && <CommissionSpatialCheck />}
    </>
  );
};
