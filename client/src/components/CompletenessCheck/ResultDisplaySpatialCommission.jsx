...
const ResultDisplaySpatialCommission = ({ results }) => {
    ...
    const commissionRate =
        totalOriginal > 0
            ? ((commissionSymbols / totalOriginal) * 100).toFixed(2)
            : "0.00";
    ...
    const handleSave = () => {
        ...
        tableData.push({});
        tableData.push({
            "Symbol Name": "Commission Rate (%)",
            "User Image Count": commissionRate,
        });
        ...
        <div style={{ marginBottom: "2rem" }}>
            ...
            >
                ...
                {results.differences.length === 0 ? (
                    <p style={{ color: "#16A34A" }}>No Commission found ✅</p>
                ) : (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        Total {commissionSymbols} Symbols missing from the Reference
                                        Image
                                    </p>
...
export default ResultDisplaySpatialCommission;
