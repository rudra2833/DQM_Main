  ...
  return (
    <MainContainer>
      <h3 style={{ marginTop: "10px", marginBottom: "10px" }}>
        Temporal Consistency: Start-End Date
      </h3>
      ...
      <div className="alert alert-primary" style={{ margin: "20px 100px", textAlign: "justify" }}>
        ...
        <br />
        <b>Reference: </b>ISO 19157:2013(E) Annex D(D.5.2) - The data quality measures for the data quality element Temporal Consistency are provided in Tables D.62. (Page No. 96)
      </div>
